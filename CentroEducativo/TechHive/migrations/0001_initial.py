    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Sucursal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TechHive.centroeducativo')),
            ],
        ),
        migrations.CreateModel(
            name='Grado',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Impuesto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='TechHive.impuestos')),
            ],
        ),
        migrations.CreateModel(
            name='TipoReporte',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DocumentoDPI', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TechHive.documentodpi')),
                ('Parentesco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TechHive.parentesco')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('Empleado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TechHive.empleado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Alumno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pagos_alumno', to='TechHive.tutoresalumnos')),
                ('Descuento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='TechHive.descuento')),
                ...
                ('Tutor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pagos_tutor', to='TechHive.tutoresalumnos')),
            ],
        ),
        migrations.CreateModel(
            name='NotasAlumnos',
        ...
        migrations.CreateModel(
            name='ImpuestoHistorico',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_inicio', models.DateTimeField()),
                ('fecha_final', models.DateTimeField(blank=True, null=True)),
                ('valor', models.DecimalField(decimal_places=2, max_digits=4)),
                ('impuesto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='TechHive.impuestos')),
            ],
        ),
        migrations.AddField(
            model_name='grado',
